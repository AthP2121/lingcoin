...
"""Verify that starting lingcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lingcoin with -h for help text")
        ...
        self.log.info("Start lingcoin with -version for version information")
        ...
        self.log.info("Start lingcoind with -fakearg to make sure it does not start")
