# Support for Output Descriptors in Lingcoin Core

Since Lingcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `ling1...` for mainnet or `tling1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Lingcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Lingcoin Core wallets, a convenience function `combo` is
