Lingcoin Core version *0.15.1* is now available from:

  <https://download.lingcoin.org/lingcoin-0.15.1/>
...
A number of changes to the way Lingcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lings per kB (0.00001 LING). This is to prepare for dropping the minimum transaction fee to 0.1 lings per kB (0.0001 LING) in the next release.
