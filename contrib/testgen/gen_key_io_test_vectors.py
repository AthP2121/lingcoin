...
bech32_templates = [
  ...
  ('ling',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('ling',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('ling',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tling',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tling',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tling',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rling',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rling',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rling', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tling',  17, 32, False, False, False),
  ('rling',  3,  1, False, False, False),
  ('ling',   15, 41, False, False, False),
  ('tling',  0, 16, False, False, False),
  ('rling',  0, 32, True,  False, False),
  ('ling',   0, 16, True,  False, False),
  ('tling',  0, 32, False, True,  False),
  ('rling',  0, 20, False, False, True)
]
