...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lingcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lingcoin-tx [options] <hex-tx> [commands]  Update hex-encoded lingcoin transaction\n" +
            "or:     lingcoin-tx [options] -create [commands]   Create hex-encoded lingcoin transaction\n" +
            "\n";
